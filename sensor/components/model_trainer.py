...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)-> artifact_entity.ModelTrainerArtifact:
        try:
            ...
            #Calculating f1 train and test score
            logging.info("Calculating f1 train and test score")
            ...
            #Checking if our model is underfitting or not
            ...
            #Checking if our model is overfiiting or not
